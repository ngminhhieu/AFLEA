...
def read_option():
    ...
    parser.add_argument('--num_groups', help='the number of groups of clients;', type=int, default=5)
...
if __name__ == '__main__':
    ...
    generator = TaskGen(dist_id = option['dist'], skewness = option['skew'], num_clients=option['num_clients'], num_groups=option['num_groups'])
    generator.run()
