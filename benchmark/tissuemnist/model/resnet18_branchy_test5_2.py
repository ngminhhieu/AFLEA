...
class Model(FModule):
    def __init__(self, block=BasicBlock, num_block=[1,2,2,2], num_classes=params[BENCHMARK]['n_labels'], base_dim=32):
        ...
        self.b01_conv2_x = self._make_layer(block, base_dim, num_block[0], 1)
        self.b1_conv3_x = self._make_layer(block, 2*base_dim, num_block[1], 2)
        self.b1_conv4_x = self._make_layer(block, 4*base_dim, num_block[2], 2)

        self.avg_pool = nn.AdaptiveAvgPool2d((1, 1))
        self.b01_fc = nn.Linear(4*base_dim * block.expansion, num_classes)
